...
/* System Settings */
    ...
    bank_civ = 300000; //Amount of cash in bank for new civillians
    bank_med = 300000; //Amount of cash in bank for new medics
