...
_rip = true;
_kassa = 100000 + round(random 20000);
...
if(_cops < 4) exitWith{[_vault,-1] remoteExec ["disableSerialization;",2]; hint "There isnt enough Police to rob Gas Station!";};
...
_Pos = position player; // by ehno: get player pos
				                ...
				                "Marker200" setMarkerText "!ATTENTION! Gas Station Robbery !ATTENTION!";
...
if(_robber distance _shop > 10.5) exitWith { deleteMarker "Marker200"; _shop switchMove ""; hint "You need to stay within 10m to Rob the register! - Now the register is locked."; 5 cutText ["","PLAIN"]; _rip = false; };
5 cutText ["","PLAIN"];
